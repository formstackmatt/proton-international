...
<section class="content content--work" id="main">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <h2 class="headline headline--primary text-center">Chris Chandler</h2>
        <h3 class="subheadline subheadline--tertiary margin-bottom-md text-center">Chief Executive Officer</h2>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <h2 class="headline headline--primary margin-bottom-md text-center">Team</h2>
      </div>
    </div>
