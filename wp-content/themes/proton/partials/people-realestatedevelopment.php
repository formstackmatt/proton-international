  ...
  <div class="col-md-3 col-md-push-9">
    ...
    <ul class="nav nav-tabs about-tabs" role="tablist" id="people-tabs">
      ...
      <?php
        ...
        <li class="">
          <a href="#redperson-<?php the_ID(); ?>" role="tab" data-toggle="tab"><?php the_title(); ?></a>
        </li>
  ...
  <div class="col-md-9 col-md-pull-3">
    <div class="tab-content">
      ...
      <?php
        ...
        <div role="tabpanel" class="tab-pane fade in cf" id="redperson-<?php the_ID(); ?>">
          <div class="thumb">
