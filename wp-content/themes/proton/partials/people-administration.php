  ...
  <div class="col-md-3 col-md-push-9">
    ...
    <ul class="nav nav-tabs about-tabs" role="tablist" id="people-tabs">
      ...
      <?php
        ...
        <li>
          <a href="#adminperson-<?php the_ID(); ?>" role="tab" data-toggle="tab"><?php the_title(); ?></a>
        </li>
    ...
    <div class="dropdown hidden-md hidden-lg text-center">
      ...
      <?php
        ...
        <li><a href="#adminperson-<?php the_ID(); ?>" role="tab" data-toggle="tab"><?php the_title(); ?></a></li>
  ...
  <div class="col-md-9 col-md-pull-3">
    <div class="tab-content">
      ...
      <?php
        ...
        <div role="tabpanel" class="tab-pane fade in cf" id="adminperson-<?php the_ID(); ?>">
          <div class="thumb">
